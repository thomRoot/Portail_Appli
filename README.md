...
**Style 1.3a : CYBER DARK**

## 🎨 Description du Style

Ce style **"Cyber Dark"** offre une interface **futuriste et sobre**, inspirée des designs cyberpunk mais adaptée pour une utilisation quotidienne en domotique.

### 🎯 Caractéristiques principales :
- **Couleurs** : Noir profond (#0a0a0a) + Bleu électrique (#00b4d8) + Violet (#9b59b6)
- **Effets** : Lueurs néon subtiles, dégradés verticaux, ombres lumineuses bleues
- **Ambiance** : Moderne, technologique, immersive
- **Inspiration** : Interfaces de science-fiction (Cyberpunk 2077, Tron) adaptées pour la domotique

### 🌌 Effets visuels :
- **Grille en arrière-plan** : Motif subtil en pointillés bleus pour un effet "matrix"
- **Bordures néon** : Contours bleus électriques autour des cartes et conteneurs
- **Dégradés** : Fond et cartes avec des dégradés sombres
- **Ombres lumineuses** : Effet "glow" bleu autour des éléments principaux
- **Effet hover** : Lueurs qui s'intensifient au survol
...
- **Design cyberpunk** : Interface épurée avec des accents néon
...
1. **Cloner le dépôt** :
   ...
   cd Portail_Appli
   git checkout 1.3a  # Pour utiliser ce style
   ```
...
1. Poussez votre code sur GitHub (branche `1.3a`)
2. Allez dans les paramètres du dépôt
3. Activez GitHub Pages dans la section "Pages"
4. Sélectionnez la branche `1.3a` et le dossier `/ (root)`
...
├── styles.css          # Styles CSS (Style Cyber Dark)
...
### Personnaliser les couleurs (Style Cyber Dark)

Modifiez les variables CSS dans `styles.css` :
```css
:root {
    /* Couleurs principales */
    --primary-color: #00b4d8;          /* Bleu électrique */
    --primary-dark: #0077b6;          /* Bleu électrique foncé */
    --secondary-color: #9b59b6;       /* Violet */
    --accent-color: #ff6b6b;          /* Rouge accent */
    
    /* Couleurs de fond et texte */
    --background-color: #0a0a0a;      /* Noir profond */
    --card-color: #1a1a1a;            /* Noir charbon */
    --text-color: #e0e0e0;           /* Blanc cassé */
