...
**Style 1.3c : DEEP SPACE**

## 🌌 Description du Style

Ce style **"Deep Space"** offre une interface **spatiale et immersive**, inspirée des designs futuristes des applications de domotique haut de gamme. Parfait pour ceux qui aiment les **effets de profondeur** et une ambiance **cosmique élégante**.

### 🎯 Caractéristiques principales :
- **Couleurs** : Noir cosmique (#050505) + Bleu profond (#1e3a8a) + Orange (#f59e0b)
- **Effets** : Dégradés radiaux, glassmorphism, ombres floues, effets de profondeur
- **Ambiance** : Immersion spatiale, élégance futuriste, profondeur visuelle
- **Inspiration** : Interfaces de science-fiction (Star Wars, Interstellar), designs de domotique premium

### 🌠 Effets visuels :
- **Fond radial** : Dégradé qui simule la profondeur de l'espace
- **Effet d'étoiles** : Motif subtil d'étoiles en arrière-plan (animé)
- **Glassmorphism** : Effet de verre dépoli sur les cartes et modales
- **Ombres floues** : Ombres douces pour un effet 3D
- **Dégradés profonds** : Couleurs qui évoluent pour simuler la profondeur
- **Backdrop blur** : Flou en arrière-plan pour un effet moderne
...
- **Design spatial** : Interface immersive avec effets de profondeur
...
- **Design** : CSS Grid, Flexbox, Animations CSS, Backdrop-filter
...
- **Note** : Pour le meilleur rendu, utilisez un navigateur qui supporte `backdrop-filter` (Chrome, Edge, Firefox récent)
...
1. **Cloner le dépôt** :
   ...
   cd Portail_Appli
   git checkout 1.3c  # Pour utiliser ce style
   ```
...
4. **Vérifier que ça fonctionne** :
   ...
   - Les effets de profondeur doivent être visibles
...
1. Poussez votre code sur GitHub (branche `1.3c`)
2. Allez dans les paramètres du dépôt
3. Activez GitHub Pages dans la section "Pages"
4. Sélectionnez la branche `1.3c` et le dossier `/ (root)`
...
├── styles.css          # Styles CSS (Style Deep Space)
...
### Personnaliser les couleurs (Style Deep Space)
...
:root {
    ...
    --primary-dark: #0f172a;          /* Bleu très foncé */
    --secondary-color: #0d1b2a;       /* Bleu nuit */
    --accent-color: #f59e0b;          /* Orange */
    
    /* Couleurs de fond et texte */
    --background-color: #050505;      /* Noir cosmique */
    --card-color: #1a1a2e;            /* Noir bleuté */
    --text-color: #d4e6f1;           /* Blanc bleuté */
    --text-light: #a3b8d1;           /* Texte léger bleuté */
    
    /* Effets */
    --background-gradient: radial-gradient(ellipse at center, #0d1b2a 0%, #050505 100%);
    --card-gradient: linear-gradient(145deg, rgba(30, 58, 138, 0.2) 0%, rgba(13, 27, 42, 0.8) 100%);
...
4. Votre site apparaîtra dans le portail avec un effet de profondeur
...
### Les effets de profondeur ne s'affichent pas
- **Vérifiez votre navigateur** : `backdrop-filter` n'est pas supporté par tous les navigateurs
  - ✅ Supporté : Chrome, Edge, Firefox (version récente)
  - ❌ Non supporté : Safari (partiellement), Opera Mini
- **Vérifiez les paramètres** : Certains navigateurs désactivent `backdrop-filter` pour des raisons de performance
...
| Navigateur | Support | Testé | Backdrop-filter |
|------------|---------|-------|------------------|
| Chrome | ✅ Oui | ✅ Oui | ✅ Oui |
| Firefox | ✅ Oui | ✅ Oui | ✅ Oui (v63+) |
| Edge | ✅ Oui | ✅ Oui | ✅ Oui |
| Safari | ✅ Oui | ❌ Non | ⚠️ Partiel |
| Opera | ✅ Oui | ❌ Non | ✅ Oui |
...
- [ ] Contrôle avancé du robot (programmation)
- [ ] Suivi en temps réel du robot
- [ ] Historique des nettoyages
- [ ] Effets de profondeur améliorés
- [ ] Animations spatiales supplémentaires
...
5. Pour les effets de profondeur, utilisez un navigateur moderne (Chrome, Edge, Firefox)
